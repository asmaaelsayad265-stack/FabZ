...
Route::prefix('v1')->group(function () {
    ...
    // Courses (protected)
    // -------------------------
    Route::middleware(['auth:sanctum', 'ensure.role:super_admin,admin,instructor,student'])
        ->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'ensure.role:super_admin,admin,instructor'])
        ->group(function () {
            Route::apiResource('/courses', \App\Http\Controllers\Api\V1\CourseController::class)->except(['index', 'show']);
        });
    ...
    // -------------------------
    Route::middleware(['auth:sanctum', 'ensure.role:super_admin,admin,student'])
        ->group(function () {
